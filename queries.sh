...
echo "$($PSQL "SELECT t.name FROM teams AS t RIGHT JOIN games AS g ON t.team_id=g.winner_id OR t.team_id=g.opponent_id WHERE g.year=2014 AND g.round LIKE 'Eighth-Final' ORDER BY t.name;")"
